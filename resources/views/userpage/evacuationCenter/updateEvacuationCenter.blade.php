                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="evacuation_latitude" class="flex items-center justify-center">Evacuation
                                Latitude</label>
                            <input type="text" name="evacuation_latitude" id="evacuation_latitude" class="form-control"
                                autocomplete="off">
                        ...
                        <div class="mb-3">
                            <label for="evacuation_longitude" class="flex items-center justify-center">Evacuation
                                Logitude</label>
                            <input type="text" name="evacuation_longitude" id="evacuation_longitude" class="form-control"
                                autocomplete="off">
