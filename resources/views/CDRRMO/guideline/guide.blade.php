    ...
    <body class="bg-gray-400">
        <div class="wrapper">
            ...
            @auth
                ...
                <a href="javascript:void(0)" id="createGuideBtn" class="bg-red-700 mx-2 p-2 py-2 text-white rounded shadow-lg hover:bg-red-900 transition duration-200">
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            url: "{{ route('Caguide', ':guideline_id') }}".replace(':guideline_id', guideline_id),
                            type: "POST",
                            dataType: 'json',
