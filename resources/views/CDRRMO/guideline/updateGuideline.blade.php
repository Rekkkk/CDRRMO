    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('Cupdateguideline', $guidelineItem->guideline_id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="mb-3">
                        <label for="guideline_description" class="flex items-center justify-center">Guideline Desctription</label>
                        <input type="text" name="guideline_description" value="{{ $guidelineItem->guideline_description }}" class="form-control" autocomplete="off">
                    </div>
