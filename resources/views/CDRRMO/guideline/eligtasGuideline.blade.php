        ...
        <div class="wrapper">
            ...
            <div class="main-content">
                ...
                <div class="guidelines-btn w-full py-2 flex justify-end">
                    <a class="bg-slate-700 mx-2 p-2 py-2 text-white rounded shadow-lg hover:bg-slate-900 transition duration-200" id="createGuidelineBtn" href="javascript:void(0)">
