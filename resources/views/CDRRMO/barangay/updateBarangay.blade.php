@auth
<div class="modal fade" id="edit{{ $barangayList->barangay_id }}" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="{{ route('Cupdatebarangay', $barangayList->barangay_id) }}" method="POST">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="bg-red-700 text-white p-2 py-2 rounded shadow-lg hover:shadow-xl transition duration-200">Update Barangay</button>
                    </div>
                </form>
            </div>
        </div>
